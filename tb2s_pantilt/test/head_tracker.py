...
if FAKE:
    CONTROLLER_TYPE = 'usb2dynamixel'
    TRACKER_TYPE = 'position'
else:
    # Specify either 'dynamixel_motor' or 'arbotix' for the controller package
    CONTROLLER_TYPE = rospy.get_param('~controller_type', 'usb2dynamixel')
...
class HeadTracker():
    def __init__(self):
        ...
        self.head_pan_joint = rospy.get_param('~head_pan_joint', 'head_pan_controller')
        self.head_tilt_joint = rospy.get_param('~head_tilt_joint', 'head_tilt_controller')
    ...
    def init_servos(self):
        ...
        for joint in sorted(self.joints):
            ...
            print('  waiting for service: ' + set_speed_service)
            ...
            print('  position controller: /' + joint + '/command')
